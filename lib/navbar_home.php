        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link dropdown-toggle" href="../pages/tour.php" id="navbarDropdown" role="button"
                           data-toggle="dropdown" aria-expanded="false">
                            Tour
                        </a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link dropdown-toggle" href="../pages/blog.php" id="navbarDropdown" role="button"
                           data-toggle="dropdown" aria-expanded="false">
                            Blog
                        </a>
