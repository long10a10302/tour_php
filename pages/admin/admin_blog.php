    ...
    <div id="layoutSidenav_content">
        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <a href="../../controller/insert_blog.php">Insert</a>
                <table class="table">
                    <thead>
                    <tr>
                        <th>Id</th>
                    ...
                    <?php foreach ($blogs as $key => $row) { ?>
                        <tr>
                            ...
                            <td><?= $row['count'] ?></td>
                            <td><a href='../../controller/edit_blog.php?id=<?php echo $row["id"]; ?>'>Edit</a> | <a
                                        href='../../controller/delete_blog.php?id=<?php echo $row["id"]; ?>'>Delete</a>
                            </td>
                        </tr>
                    <?php } ?>
                    </tbody>
