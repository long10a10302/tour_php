...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO tbl_tour (name,description, price, day,img_id,status,plan_tour,note) VALUES ('$name', '$description', '$price', '$day','$imgId','$status','$plan','$note')";
...
<form action="" method="POST">
    ...
    Description: <textarea name="description" id="" cols="50" rows="50"></textarea><br>
    ...
    Note: <textarea name="note" id="" cols="50" rows="50"></textarea><br>
